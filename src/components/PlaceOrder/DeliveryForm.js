...
const DeliveryForm = () => {
    ...
    const handleSubmit = (e) => {
        ...
        swal("Information Updated!", "Your Doctors Appoinment details updated successfully!", "success")
        setDisabled(false)
    }

    return (
        <div className="flex flex-col mt-20">
            <h1 className="text-2xl poppins pb-4 border-b border-gray-500 text-gray-700">Edit Appoinment Details</h1>
